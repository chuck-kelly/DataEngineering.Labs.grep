...
```
ggrep -cP started transaction_data_daily_event_log_20190129.dat
```
...
```
-P failure transaction_data_daily_event_log_20190129.dat | wc -l
```

Upon review, we would like to only view failures with error code SYSOFFLINE or WEAKSIGNAL.

```
ggrep -P 'SYSOFFLINE|WEAKSIGNAL' transaction_data_daily_event_log_20190129.dat
```
